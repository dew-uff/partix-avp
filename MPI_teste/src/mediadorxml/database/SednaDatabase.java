...
public class SednaDatabase extends BaseDatabase {
    ...
    public void loadFileInCollection(String collectionName, String filePath)
            throws XQException {
        executeCommand("LOAD '" + filePath + "'" + " '" + collectionName +"'");
    }
    ...
    public void setHost(String host) {
        SednaXQDataSource sednaDs = (SednaXQDataSource) dataSource;
        sednaDs.setServerName(host);
    }

    @Override
    public void setPort(int port) {
        SednaXQDataSource sednaDs = (SednaXQDataSource) dataSource;
        sednaDs.setPort(port);
    }

    @Override
    public void setUsername(String username) {
        SednaXQDataSource sednaDs = (SednaXQDataSource) dataSource;
        sednaDs.setUser(username);        
    }

    @Override
    public void setPassword(String password) {
        SednaXQDataSource sednaDs = (SednaXQDataSource) dataSource;
        sednaDs.setPassword(password);
    }
}
