...
import commons.AbstractDatabase;
import commons.DatabaseProperties;

public class PartiXVPDatabaseMetaData implements DatabaseMetaData, Serializable {
	/**
	 * 
	 */
    ...
    public PartiXVPDatabaseMetaData(DatabaseProperties prop, DatabaseProperties sort, XQMetaData meta) {
		try {
			databaseSpecifics = AbstractDatabase.getDatabaseSpecifics(meta.getProductName());
			this.prop = prop;
	...
	public PartiXVPDatabaseMetaData(DatabaseProperties prop, DatabaseProperties sort, DatabaseMetaData meta) {
		try {
