package localqueryprocessor.localquerytask;
...
import localqueryprocessor.dynamicrangegenerator.avp.queryexecutor.QueryExecutor;
import localqueryprocessor.dynamicrangegenerator.avp.queryexecutor.QueryExecutorAVP;
import localqueryprocessor.dynamicrangegenerator.avp.queryexecutor.QueryExecutorFgvp;
import resultcomposer.ResultComposer;
import resultcomposer.ResultComposerDistributed;
import resultcomposer.ResultComposerEngineDistributed;
import resultcomposer.ResultComposerEngineLocal;
import resultcomposer.ResultComposerGlobal;
import resultcomposer.ResultComposerLocal;
        ...
        try {
            ...
            if (localResultComposition) {
                ...
                if (queryInfo.isDistributedComposition()) {
                    groupResultComposerDistributed = new ResultComposerEngineDistributed(id, globalResultComposer, numlqts, queryInfo, this);
            ...
            case GlobalQueryTask.QE_STRATEGY_AVP: {
                qe = new QueryExecutorAVP(this, dbpool, resultComposer, query, range, statistics);
                break;
            }
            default:
