...
import globalqueryprocessor.clusterqueryprocessor.ConnectionManagerImpl;
import globalqueryprocessor.clusterqueryprocessor.querymanager.AbstractQueryManager;
...
public class QueryScheduler implements Runnable {
	...
	public int executeUpdate(AbstractQueryManager s) throws RemoteException, XQException {
		//Isto é thread-safe?		
		put(s);
		int count = -1;
		try {
