...
public class Catalog {
	...
	// Diret�rios onde os arquivo com os fragmentos e os resultados s�o gerados.
	// O usu�rio deve especificar no cat�logo o caminho do arquivo no computador local, onde o sistema est� sendo executado.
	protected String svpDirectory;	
	protected String avpDirectory;
	protected String partialResultDirectory;
	
	/* Par�metros utilizados para conex�o com o banco de dados Sedna*/
	...
	public String getFormattedDocumentsQuery(String collectionName){
		...
		xqueryReturn = xqueryReturn.replace("?", collectionName); // adiciona o nome da cole��o		
		return xqueryReturn;
	}
