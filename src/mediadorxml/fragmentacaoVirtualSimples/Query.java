...
public class Query {
	...
	protected String queryExprType; // Indica se a consulta informada pelo usu�rio utiliza a cl�usula doc() ou a cl�usula collection();
	protected String fragmentationAttribute; // Indica o caminho xpath do atributo de fragmenta��o virtual	
	protected String virtualPartitioningVariable; // Indica��o da vari�vel de fragmenta��o, nos casos em que existem jun��es
	protected int verifiedJoins;
	protected int lastJoinCardinality; // A cardinalidade da jun��o, quando h� mais de um For com doc() clauses 
	protected boolean joinCheckingFinished; // indica se a verifica��o dos joins j� acabou
	protected int lastCollectionCardinality; // A cardinalidade da jun��o, quando h� mais de um For, por�m com collection() clauses
	...
	protected String partitioningPath; // O caminho at� o atributo de fragmenta��o, quando h� mais de um For, por�m com collection() clauses
    ...
    protected Hashtable<String, String> aggregateFunctions; // indica as fun�oes de agrega��o que devem ser acrescentadas no final.
	...
	public void setAggregateFunctions(String aggregateFunction, String variableName, String comparisonOp) {
		...
		if ( comparisonOp!=null && !comparisonOp.equals("") ) { // count de cla�sulas Where em consultas com FOR									
	...
	/***
	 * Este m�todo verifica se a consulta de entrada � aplicada sobre um documento ou sobre uma cole��o.
	 * @param inputQuery A consulta de entrada atrav�s da interface.
	 * @throws IOException 
	 */
	...
	public String getPathVariable(String variableName){
		...
		String path = this.forClauses.get(variableName); // caminho da vari�vel
	...
	public String getDocumentNameByVariableName(String variableName) {
		...
		<chave, conteudo> onde a chave � o nome da vari�vel XML, incluindo o caracter $ (ex.: $order)
		e conteudo � o caminho completo sobre o qual a vari�vel est� definida.
		
		Este caminho � expresso segundo o seguinte padr�o: 
		...
		*/
		...
		int posComma = path.indexOf(":"); // posi��o do primeiro caracter (:)
