...
public class LocalView extends View {
	...
	protected ArrayList<WrapperLocation> wrapperLocation;      // Localização da view local
	protected String referenceCollection;	  // Colleção sobre a qual o predicado é aplicado
	protected ArrayList<String> selectionPredicates;  // Predicados de seleção que define a formação do fragmento
	protected ArrayList<String> projectionPredicates; // Predicados de projeção
